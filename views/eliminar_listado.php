        ...
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="eliminar_listado.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="pt-3 pb-2 mb-3 border-bottom">
                    <h2>Listado para Eliminar Productos</h2>
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered table-hover shadow rounded">
                        <thead style="background-color: #f8d7da; color: #842029;">
                        ...
                        <tbody>
                            <?php while ($producto = mysqli_fetch_assoc($resultado)): ?>
                                <tr class="align-middle">
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm text-white" style="background-color: #dc3545;" onclick="confirmarEliminacion(<?= $producto['id']; ?>)">
                                            Eliminar
                                        </button>
                                    </td>
                                </tr>
